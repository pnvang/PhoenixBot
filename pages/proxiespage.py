...
class ProxiesPage(QtWidgets.QWidget):
    ...
    def setupUi(self, proxiespage):
        ...
        self.proxiespage.setGeometry(QtCore.QRect(60, 0, 1041, 651))
        ...
        self.proxies_card.setGeometry(QtCore.QRect(30, 70, 981, 551))
        font = QtGui.QFont()
        ...
        self.proxies_edit.setGeometry(QtCore.QRect(20, 90, 941, 391))
        ...
        self.deleteproxies_btn.setGeometry(QtCore.QRect(500, 500, 86, 32))
